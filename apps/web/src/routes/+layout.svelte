...
<header class="sticky top-0 z-30 border-b border-line bg-bg/90 backdrop-blur">
	<nav class="content-wrap flex items-center justify-between gap-3 py-3">
		<button
			type="button"
			class="rounded-lg border border-line p-1.5 md:hidden"
			aria-label="Menu"
		...
		<a href={localize('/', data.locale)} class="flex items-center gap-2 text-sm font-extrabold tracking-tight md:text-lg md:flex-1">
			<FishMark cls="h-5 w-5 text-accent-strong md:h-7 md:w-7" />
			Cahaya Bahari 89
		</a>
...
<footer class="mt-16 bg-brand text-brand-ink">
	<div class="content-wrap grid gap-8 py-8 sm:grid-cols-2">
		<div>
			<span class="flex items-center gap-2 text-sm font-extrabold md:text-lg">
		...
		<div>
			...
			<div class="mt-3 flex gap-2.5">
				...
				<a href="https://www.instagram.com/cahayabahari89" target="_blank" rel="noreferrer" aria-label="Instagram" title="Instagram" class="flex h-8 w-8 items-center justify-center rounded-full border border-white/25 transition hover:border-accent hover:text-accent md:h-10 md:w-10">
				...
				<a href="https://www.youtube.com/@cahayabahari89" target="_blank" rel="noreferrer" aria-label="YouTube" title="YouTube" class="flex h-8 w-8 items-center justify-center rounded-full border border-white/25 transition hover:border-accent hover:text-accent md:h-10 md:w-10">
